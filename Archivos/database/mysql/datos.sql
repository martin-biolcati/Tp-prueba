...
VALUES 
(1, 'Porsche 911 GT3', 'Auto usado por 1 año en muy buen estado.'),
(2, 'LAMBORGHINI AVENTADOR SVJ', 'Auto sin usar en perfectas condiciones.' ),
(3, 'FERRARI 812 COMPETIZONE', 'Auto usado por 2 años en muy buen estado.'),
...
(7, 'LOTUS EMIRA', 'Auto usado por 1 año en muy buen estado.'),
(8, 'ROLLS ROYCE PHANTOM', 'Auto sin usar en perfectas condiciones.' ),
(9, 'PAGANI HUAYRA', 'Auto usado por 3 años en muy buen estado.'),
...
USE `luxury_cars`;
INSERT INTO `comentarios` (cliente_id, producto_id, comentario)
VALUES 
('1', '1', 'Muy lindo auto'),
